    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, node_fetch_1["default"])(req.getURL(), {
                            method: req.args[0],
                            agent: httpsAgent,
                            headers: {
                                Authorization: 'Basic ' + Buffer.from("".concat(Username, ":").concat(Password)).toString('base64')
                            }
                        })];
                case 1:
                    response = _a.sent();
